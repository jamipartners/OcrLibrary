...
#ifndef OCRFRAMEWORK_SWIFT_H
#define OCRFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OcrFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12OcrFramework23CustomActivityIndicator")
...
SWIFT_CLASS("_TtC12OcrFramework22DrawingBoundingBoxView")
@interface DrawingBoundingBoxView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12OcrFramework14MeasureLogView")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC12OcrFramework13OcrController")
...
@interface OcrController (SWIFT_EXTENSION(OcrFramework))
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified fatherName;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified gender;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified countryOfStay;
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified nic_image_back;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12OcrFramework12VideoCapture")
...
@interface VideoCapture (SWIFT_EXTENSION(OcrFramework)) <AVCaptureVideoDataOutputSampleBufferDelegate>
